...
public class Stats : MonoBehaviour
{
    ...
    {
        attributes.Add(TheBeyond.Enums.AttributeType.Constitution, 1);
        attributes.Add(TheBeyond.Enums.AttributeType.Wisdom, 1);

        health.SetMax(attributes.GetMaxHealth());
        mana.SetMax(attributes.GetMaxMana());

        health.points = health.maximumPoints;
        mana.points = mana.maximumPoints;

        character.model.soundManager.PlayLevelUp();
    }
